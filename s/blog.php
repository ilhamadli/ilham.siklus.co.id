                        ...
                        <?php foreach ($posts as $post): ?>
                            ...
                            <div class="block-21 mb-4 d-flex">
                                ...
                                <div class="text">
                                    ...
                                    <h1 class="heading text-primary"><u><a href="<?= BASE_URL . 'blog.php?post-slug=' . htmlspecialchars($post['slug']) ?>"><?= htmlspecialchars($post['title']) ?></a></u></h1>
			...
			<div class="row mb-2">
				...
				<div class="col-md">
					...
					<div class="ftco-footer-widget mb-4">
						...
						<h2 class="ftco-heading-2"><?= $lang['ABOUT_TITLE'] ?></h2>
