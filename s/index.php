					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu">
							...
							<?php foreach ($products as $product): ?>
								...
								<a class="dropdown-item" href="<?= BASE_URL . 'products/' . htmlspecialchars($product['title']) ?>"><?= htmlspecialchars($product['title']) ?></a>
			...
			<div class="row ftco-animate mb-2">
				...
				<div class="col">
					...
					<div class="product">
						...
						<a href="<?= BASE_URL . 'products.php?title=' . htmlspecialchars($product['title']) ?>"><img src="<?= BASE_URL . '/admin/img/product_image/' . $product['image'] ?>"></a> 

						<button type="button" class="tombol"><h3><a href="<?= BASE_URL . 'products.php?title=' . htmlspecialchars($product['title']) ?>"><?= htmlspecialchars($product['title']) ?></a></h3</button>
					...
					<div class="col-md-7 col-lg-4 d-flex ftco-animate">
						...
						<div class="blog-entry text-center">
							...
							<div class="containerblog">
								...
								<a href="<?= BASE_URL . 'blog.php?post-slug=' . htmlspecialchars($post['slug']) ?>" class="block-20" style="background-image: url('<?php echo BASE_URL . '/admin/img/post_image/' . $post['image']; ?>');">
		...
		<div class="container desktop pb-5">
			...
			<div class="row d-flex contact-info pb-5">
				...
				<div class="col d-flex ftco-animate">
					...
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.2746061242647!2d106.80491801529517!3d-6.227480162723933!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f13dae348f75%3A0x59801b675cfb09e8!2sWeWork%20Revenue%20Tower!5e0!3m2!1sen!2sid!4v1594117901147!5m2!1sen!2sid" 
