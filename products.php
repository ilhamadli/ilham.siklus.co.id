<?php 
  ...
  if (!isset($_GET['title'])) {
    ...
    $product = getSingleProduct($_GET['title']);
?>
  ...
  <head>
    ...
    <title>Siklus - Product | <?= $product['title'] ?></title>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse text-light" id="ftco-nav">
          <ul class="navbar-nav nav ml-auto">
            <li class="nav-itemlanguage nav-item"><a href="<?=  $_GET['title'] . '&lang=en' ?>" class="nav-link <?php if($_GET['lang'] == "en"){echo "active";} ?>"><span>EN</span></a></li>
            <li class="nav-itemlanguage nav-item"><a href="<?= $_GET['title'] . '&lang=id' ?>" class="nav-link <?php if($_GET['lang'] == 'id'){echo 'active';} ?>"><span>ID</span></a></li>
          </ul>
        </div>
      </div>
    </nav>  
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center ">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            <!-- title -->
            <h1 class="mb-3 bread text-white"><?= htmlspecialchars($product['title']) ?></h1>
            <!-- title end -->
          </div>
        </div>
      </div>
