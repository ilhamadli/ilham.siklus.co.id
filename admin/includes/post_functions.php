...
function createPost($request_values) {
  ...
  if (!in_array($fileActualExt, $allowed)) {
    ...
    if (mysqli_num_rows($result) > 0) { 
      ...
      $id = $usRow['id'];
      $query = "INSERT INTO posts (user_id, title, slug, image, body, body_id, text_highlight, category, published, created_at, updated_at) VALUES('$id', '$title', '$post_slug', '$fileNameNew', '$body', '$body_id', '$highlight', '$topic_name', $published, now(), now())";
